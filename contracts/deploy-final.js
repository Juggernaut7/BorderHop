...
async function main() {
  console.log("🚀 FINAL DEPLOYMENT - BorderHopHook to Ethereum Sepolia...");
  
  // Use a reliable RPC endpoint (DRPC)
  ...
  try {
    ...
    if (balance === 0n) {
      console.log("❌ No ETH in wallet! Get Sepolia ETH from: https://sepoliafaucet.com/");
      return;
    }
  } catch (error) {
