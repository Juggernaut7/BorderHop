...
async function main() {
  console.log("🚀 LOCAL DEPLOYMENT - BorderHopHook to Ethereum Sepolia...");
  
  // Use a reliable RPC endpoint
  const provider = new ethers.JsonRpcProvider("https://sepolia.drpc.org");
  
  // Create wallet from private key
  const privateKey = process.env.PRIVATE_KEY || "0x5eae75e9a093a6e5f654ce2ce792ab88f79167994cc606b225805ee9adbfa502";
  if (!privateKey) {
