...
async function main() {
  console.log("🚀 QUICK DEPLOYMENT - BorderHopHook to Ethereum Sepolia...");
  
  // Use public RPC endpoints to bypass Infura issues
  const provider = new ethers.JsonRpcProvider("https://rpc.sepolia.org");
  
  // Create wallet from private key (you'll need to add this to .env)
